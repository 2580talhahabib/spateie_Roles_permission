    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="{{route('articles.update',$edit->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                <div class="m-5">
                    <label for="" class="text-lg font-medium text-gray-600">Title</label>
                    <br>
                    <input type="text" name="title" value="{{ $edit->title }}" class="border-gray-300 shadow-sm w-96 rounded-lg p-2" >
                </div>
                @error('title')
                ...
                @enderror
                   ...
                   <div class="m-5">
                    ...
                    <textarea name="text" value="{{ $edit->text }}" class="border-gray-300 shadow-sm w-96 rounded-lg p-2" cols="20" rows="4"></textarea>
                </div>
                @error('text')
                <div class="text-red-600">
                         {{ $message }}
                ...
                <div class="m-5">
                    ...
                    <br>
                    <input type="text" name="auther" value="{{ $edit->auther }}" class="border-gray-300 shadow-sm w-96 rounded-lg p-2" >
                </div>
                @error('auther')
                <div class="text-red-600">
                         {{ $message }}
