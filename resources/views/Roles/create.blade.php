            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @enderror
                  <div class="mt-3">
                    ...
                    <label for="permissions-{{ $permissions->id }}"> <input type="checkbox" id="permissions-{{ $permissions->id }}" value="{{ $permissions->name }}" class="m-1 rounded" name="permission[]">{{ $permissions->name }} </label><br>
                    @endforeach
